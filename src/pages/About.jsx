  ...
  return (
    <section className="max-container">
      <h1 className="head-text">
        Hey, I'm <span className="blue-gradient_text font-semibold drop-shadow">AnhCBT</span>
      </h1>
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          Crafting solutions tailored to your needs – explore a range of tailored services designed to elevate your
